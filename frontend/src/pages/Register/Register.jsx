            ...
            {isSuccess ? (
              ...
              >
                ...
                <p style={{ color: '#666666', fontSize: '0.95rem' }}>
                  Initializing your personal knowledge graph...
                </p>
              </motion.div>
            ) : (
              <motion.div
                key="register-form-screen"
              ...
              >
                ...
                {/* Headings */}
                <motion.div variants={elementVariants} style={{ marginBottom: '0.85rem' }}>
                  ...
                  <p style={{ color: '#666666', fontSize: '0.9rem' }}>
                    Start connecting your notes, files, and intelligence.
                  </p>
                </motion.div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                  ...
                  <motion.div variants={elementVariants} className="form-group">
                    <label style={{ display: 'block', fontSize: '0.8rem', fontWeight: 500, color: '#111111', marginBottom: '0.2rem' }}>
                      Full name
                    </label>
                    <input
                      type="text"
                      ...
                      style={{
                        ...
                        border: errors.name ? '1px solid #EF4444' : '1px solid rgba(17, 17, 17, 0.15)',
                        borderRadius: '4px',
                        outline: 'none',
                      ...
                      onBlur={(e) => {
                        e.target.style.borderColor = errors.name ? '#EF4444' : 'rgba(17, 17, 17, 0.15)';
                    ...
                    <AnimatePresence>
                      {errors.name && (
                        <motion.span
                          ...
                          style={{ display: 'block', color: '#EF4444', fontSize: '0.8rem', marginTop: '0.3rem' }}
                        >
                          {errors.name}
                        </motion.span>
                      )}
                    ...
                    <AnimatePresence>
                      {errors.password && (
                        <motion.span
                          ...
                          animate={{ opacity: 1, height: 'auto' }}
                          exit={{ opacity: 0, height: 0 }}
                          style={{ display: 'block', color: '#EF4444', fontSize: '0.8rem', marginTop: '0.3' }}
                        >
                          {errors.password}
                        </motion.span>
                      )}
                    ...
                    <div style={{ position: 'relative' }}>
                      <input
                        ...
                        style={{
                          ...
                          color: '#111111',
                          backgroundColor: 'transparent',
                          border: errors.confirmPassword ? '1px solid #EF4444' : '1px solid rgba(17, 17, 17, 0.15)',
                          borderRadius: '4px',
                          outline: 'none',
                          transition: 'border-color 0.25s, box-shadow 0.25s'
                        }}
                        ...
                        onBlur={(e) => {
                          e.target.style.borderColor = errors.confirmPassword ? '#EF4444' : 'rgba(17, 17, 17, 0.15)';
                          e.target.style.boxShadow = 'none';
                        }}
                      />
                      <button
                        ...
                        onMouseLeave={(e) => e.currentTarget.style.opacity = 0.6}
                      >
                        {(showConfirmPassword ? eyeOffPng : eyePng) && (
                          <img
                            src={showConfirmPassword ? eyeOffPng : eyePng}
                            alt="Toggle password visibility"
                            style={{ width: '18px', height: '18px' }}
                          />
                        )}
